...
import { Loader2, CheckCircle2, XCircle, Shield, Key, Info, Lock } from 'lucide-react';
      ...
      <div className="container mx-auto p-6 max-w-5xl space-y-12">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-slate-500 font-medium max-w-2xl">
            Manage your connection to Meta Graph API and monitor your application&apos;s access permissions.
          </p>
        </div>
            ...
            <CardContent className="pt-8 space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-[11px] font-bold text-slate-400 flex items-center gap-2">
                  ...
                  Generate tokens in the Facebook Graph API Explorer.
                </p>
              </div>
            </CardContent>
              ...
              {fetching ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-2xl bg-slate-50 border border-slate-100 flex items-center justify-between">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Active Token</span>
