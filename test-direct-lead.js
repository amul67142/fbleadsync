...
const LEAD_ID = '10161405021575834';
...
async function run() {
    try {
        console.log(`Fetching lead ${LEAD_ID} with minimal fields...`);
        const res = await makeRequest('GET', `/v19.0/${LEAD_ID}?access_token=${PAGE_TOKEN}`);
